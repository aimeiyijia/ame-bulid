...
const process = require("process"),
	chalk = require("chalk");
const { getAnswers } = require("./core/interaction/cmdinterface");
const { fileExit } = require("./core/check.js");
const { execBuild } = require("./core/generate.js");
const { connectServe } = require("./core/dispatch/connect.js");
const { sendFile } = require("./core/dispatch/dispatch.js");
